...
const BentoTilt = ({children, className =''}) =>{
    ...
    const handleMouseMove = (e) => {
        ...
        const tiltX = (relativeY - 0.5) * 70;
        const tiltY = (relativeX - 0.5) * -70;
    ...
    <section className='bg-black pb-52'>
        <div className='container mx-auto px-3 md:px-10'>
            ...
            <p className='max-w-md font-circular-web text-lg'>
                Immerse yourself in a rich and ever-expanding universe where a vibrant array of products coverage into an interconnected overlay experience on your world.
            </p>
            </div>
        <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflowh-hidden rounded-md md:h-[65vh]'>
            <BentoCard 
                ...
                title={<>radia<b>n</b>t</>}
                description="A cross-platform metagame app, turning your activities across Web2 qnd Web3 games into a rewarding adventure."
